...
And User will enter credit card details for credit card details Card name "Discover" card number "6011000400000000" Exp Month "Aug" Exp Year"2028" CVV "241" CardHolder Name "AutomationUserUSCC"
